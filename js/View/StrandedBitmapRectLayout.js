 ...
 * Handles having rectangles on a "postive" axis and "negative" axis
 * for stranded smRNA reads
 * Will maintain two separate lists of negative and positve
 * note: negative strand acts like the original data. postive strand
 * acts differently since height increases negatively
 *
 * 'pitchX' and 'pitchY' are ratios of input scale resolution to
 * internal bitmap resolution
*/
define(
    "SmallRNAPlugin/View/StrandedBitmapRectLayout", ['dojo/_base/declare'],
    function( declare ) {
return declare( null,{
    /**
    ...
    addRect: function( id, left, right, height, data ) {
        ...
        if(strand == -1 ){
            ...
            topStart = this.originY + (this.displayMode == 'compact' ? 2 : 1);
